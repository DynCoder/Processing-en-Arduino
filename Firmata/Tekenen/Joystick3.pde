...
void setup() {
  ...
  arduino = new Arduino(this, "COM6", 57600); //SERIELE POORT
...
void draw() {
    ...
    float plusx = (map((arduino.analogRead(1)),0,1023.2,0,1024)-503)/128;     //calibrate//
    float plusy = (map((arduino.analogRead(0)),0,1023.2,0,1024)-509)/128;     //kalibreer//
